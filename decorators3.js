                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, value.apply(this, args)];
                        case 1:
                            out = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    users = new Users();
                    return [4 /*yield*/, users.getUser(22)];
                case 1:
                    user = _a.sent();
                    console.log("Got ".concat(JSON.stringify(user)));
                    return [4 /*yield*/, users.getUser(42)];
                case 2:
                    _a.sent();
